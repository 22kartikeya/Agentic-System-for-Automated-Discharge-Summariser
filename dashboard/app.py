...
def _sidebar() -> str:
    """Patient search + page navigation. Sidebar stays pinned."""
    ...
    with st.sidebar:
        ...
        st.markdown(
            selected_patient_card_html(current, name),
            unsafe_allow_html=True,
        )
        ...
        if needle:
            ...
            if hints:
                st.markdown(
                    '<div class="sb-suggest-label">Suggestions</div>',
                    unsafe_allow_html=True,
                )
                for pid in hints:
                ...
                st.markdown(
                    '<div class="sb-empty-hint">No matching patients found.</div>',
                    unsafe_allow_html=True,
                )
